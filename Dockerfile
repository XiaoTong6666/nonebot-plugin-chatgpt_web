...
RUN mkdir -p /root/.vnc && echo "123456" | vncpasswd -f > /root/.vnc/passwd && chmod 600 /root/.vnc/passwd && mkdir /root/.config && cp -r /root/.vnc /root/.config/tigervnc
...
RUN pip config set global.index-url https://pypi.tuna.tsinghua.edu.cn/simple && \
    ...
    python3 -m pip install 'nonebot2[fastapi,httpx,websockets]' && \
